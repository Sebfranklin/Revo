document.addEventListener('DOMContentLoaded', () => {
    ...
    clearChatBtn.addEventListener('click', () => {
        ...
        // For now, we don't have a DELETE endpoint. So we just clear the local state
        // and reload the conversation, which will show the welcome message.
        // A future improvement would be a DELETE request to the API.
        conversationHistory = []; 
        loadConversation();
    });
